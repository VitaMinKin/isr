        ...
        <div class="row card-body">
                <div class="tab-content col" id="objectTabContent">
                    ...
                    <div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="documents-tab">
                        <div class="row0">
                            <div class="col">
                                <h5> Документы, которые требуется отработать </h5>

                                <div class="row">
                                    <div class="col-4">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            @foreach ($documents as $document)
                                                <a class="list-group-item list-group-item-action" id="list-{{ $loop->iteration }}" data-toggle="list" href="#list-content-{{ $loop->iteration }}" role="tab" aria-controls="docs"> {{ $document }} </a>
                                            @endforeach
                                    ...
                                    <div class="col-8">
                                        <div class="tab-content" id="nav-tabContent">
                                                            ...
                                                            <div class="list-group-item list-group-item-action">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col border-right d-flex align-self-center justify-content-center">
                                                                        <div>
                                                                            <span class="font-weight-bold"> Предварительный учет: </span><br /> {{ $document->preliminary_accounting ?? "-" }} <br />
                                                                            <span class="font-weight-bold"> Постоянный учет: </span> <br /> 
                                                                    ...
                                                                    <div class="col border-right d-flex align-self-center justify-content-center">
                                                                    <!-- Срок действия -->
                                                                        {{ $document->validity ?? "Сроки не установлены!" }}
                                                                    </div>
                                            ...
                                            <!-- <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">первая</div>
                                            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">вторая</div>
                                            <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">третья</div>
                                            <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">четвертая</div> -->
                                        </div>
                                    </div>
                                 </div>
                        ...
                        <div class="row">
                            <div class="col mt-5">
                                <h5> Отработанные документы и проекты документов по вводу объекта информатизации в эксплуатацию </h5>
                                <div class="list-group">
                                    ...
                                    @else
                                        <div class="list-group-item list-group-item-action disabled">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <p class="text-muted m-0 p-0">Срок действия</p>        
                                                </div>
                                                <div class="col">
