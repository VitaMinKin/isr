                                    ...
                                    <div class="col-4">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            @foreach ($documents as $document)
                                                <a class="list-group-item list-group-item-action" id="list-{{ $loop->iteration }}" data-toggle="list" href="#list-home" role="tab" aria-controls="home"> {{ $document }} </a>
                                            @endforeach
                                                ...
                                                <div class="row .bg-light">
                                                    ...
                                                    <div class="col">
                                                        <h6 class="card-title mb-2 font-weight-bold">
                                                            <a href="{{ route('documents.edit', $document) }}" data-toggle="tooltip" data-placement="bottom" title="Редактировать" class="text-uppercase"> {{ $document->documentName->title }} </a>
                                                        </h6>
                                                    </div>
